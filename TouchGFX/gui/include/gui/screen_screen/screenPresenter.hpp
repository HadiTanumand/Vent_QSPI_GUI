...
public:
    ...
    virtual ~screenPresenter() {};
		...
		virtual void savePrevPageName(char pageName);
		virtual void SetMonitorStateInModel(float monitorState);
		virtual void setCircuitType(float circuitType);
		virtual void setMaskType(float maskState);
